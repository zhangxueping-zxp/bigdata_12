package cn.itcast.readboard.producer;

import cn.itcast.readboard.domain.PaymentInfo;
...
public class PayMentInfoProducer {
    ...
    public static void main(String[] args){
        ...
        while (true){
            //3、发送数据
                kafkaProducer.send(new ProducerRecord<String, String>("itcastorderd",new PaymentInfo().random()));
